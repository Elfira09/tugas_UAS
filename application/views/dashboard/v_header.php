...
<head>
    ...
    <title>Rumah Sakit Sayang | Dashboard</title>
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="stylesheet" href="<?php echo base_url();
                                    ?>assets3/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets3/bower_components/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url();
    ...
    <link rel="stylesheet" href="<?php echo base_url();
                                    ?>assets3/bower_components/morris.js/morris.css">
    <link rel="stylesheet" href="<?php echo base_url();
                                    ?>assets3/bower_components/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets3/bower_components/bootstrapdatepicker/dist/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets3/bower_components/bootstrapdaterangepicker/daterangepicker.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets3/plugins/bootstrapwysihtml5/bootstrap3-wysihtml5.min.css">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" datatoggle="dropdown">
                                <img src="<?php echo base_url();
                                            ?>assets3/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="<?php echo
                                                base_url(); ?>assets3/dist/img/user2-160x160.jpg" class="img-circle"
                                        alt="User Image">
                                    <p>
            ...
            <section class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo base_url();
                                    ?>assets3/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    </div>
